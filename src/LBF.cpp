...
string traindata_root = "F:/GFI/facealign/dataset/train";
string testdata_root = "F:/GFI/facealign/dataset/test";
...
//    }
    ...
    if (argc==1){
        PrintHelp();
	        ...
	        TrainModel(traindata_root);
    }
    else if (strcmp(argv[1], "test")==0){
        double MRSE = TestModel(testdata_root);
...
void PrintHelp(){
    cout << "Useage:"<<endl;
    cout << "1. train your own model:    facealign  TrainModel "<<endl;
    cout << "2. test model on dataset:   facealign  TestModel"<<endl;
    cout << "3. test model via a camera: facealign  Demo "<<endl;
    cout << "4. test model on a pic:     facealign  Demo xx.jpg"<<endl;
    cout << "5. test model on pic set:   facealign  Demo Img_Path.txt"<<endl;
    cout << endl;
}
